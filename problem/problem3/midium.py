...
# Load the medium model for higher accuracy in POS tagging and root verb parsing
...
pattern_1 = [{"POS": "VERB"}, {"POS": "ADJ", "OP": "*"}, {"POS": "NOUN", "OP": "+"}, {"LOWER": "using"}, {"POS": "PROPN"}]
